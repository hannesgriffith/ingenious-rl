...
def main():
    test_player_params = {"player_type": "computer", "strategy_type": "rl_3ply", "network_type": "mlp_v3", "ckpt_path": "best_ckpts/mlp_v3_best_self_0308_0926.pth"}
    other_player_params = {
        ...
        "mlp_v3": {"player_type": "computer", "strategy_type": "rl", "network_type": "mlp_v3", "ckpt_path": "best_ckpts/mlp_v3_best_self_0308_0926.pth"},
    }
